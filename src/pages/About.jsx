  ...
  return (
    <div>
      <div className='about' id='about'>
        ...
        <div data-aos='zoom-in' data-aos-easing='linear' className='me'>
          ABOUT ME
        </div>
        <h1
          data-aos='fade-up'
          ...
          className='self'
        >
          A SELF-MOTIVATED AND PASSIONATE DEVELOPER WITH WILD INTEREST IN
        ...
        <h1
          ...
          className='self'
        >
          NOT ONLY WRITING CODES OR DESIGN- ING BUT WRITING CLEAN CODES AND
          BUILD EFFICIENT STUFFS THAT WOULD PUT A SMILE ON THE USERS FACE.
        </h1>
        <div
          data-aos='flip-left'
        ...
        <div>
          ...
          >
            ...
            about building web based experiences.<br></br>I like to build
            experiences that are delightful,<br></br>
